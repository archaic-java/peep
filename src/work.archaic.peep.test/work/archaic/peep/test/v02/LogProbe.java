...
public final class LogProbe {
    ...
    private static void failure() {
        ...
        Log log = service(Log.class);
        expect(IOException.class, () -> log.write("immediate"));
        expect(IOException.class, () -> log.write(report("failure")));
        expect(NullPointerException.class, () -> log.write((String) null));
        expect(NullPointerException.class, () -> log.write((FailureReport) null));
    }
